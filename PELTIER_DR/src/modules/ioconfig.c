...
void PortBConf(void)
{
    ...
    GPIOB->CRH   &= ~GPIO_CRH_MODE10;      //ќчистить биты MODE
    GPIOB->CRH   &= ~GPIO_CRH_CNF10;       //ќчистить биты CNF
    GPIOB->CRH   |=  GPIO_CRH_MODE10_1 ;   //¬ыход,частота 2MHz
    GPIOB->CRH   |=  GPIO_CRH_CNF10_0;     //ќткрытый сток общего назначени€
    GPIOB->ODR   |=  1<<10 ;               //отпустить шину
